...
export interface StorageAdapter {
  getMeta(path: string): Promise<Nullable<StoredFileNode>>
  getMetaById(id: string): Promise<Nullable<StoredFileNode>>
  ...
  getContent(id: string): Promise<Nullable<FileContent>>
